...
class Menu(Scene):
    ...
    def __init__(self, app):
        ...
        colors = [Color(BUTTON_COLOR) for i in range(button_count)]
        self.widgets.append(Button_grid(app, self, 0.1, 0.1, 0.8, 0.8, 0, 0.05,
                               1, button_count, b_names, colors,
                               unclick_funcs, values = scenes + [None]))
